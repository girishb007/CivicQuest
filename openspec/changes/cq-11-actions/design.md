...
This is CQ-11 of the approved V1 delivery. See docs/DECISIONS.md and proposal.md.

## Goals / Non-Goals

Deliver admin-managed civic actions; no paid deployment or public launch.
